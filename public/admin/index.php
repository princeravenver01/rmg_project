...
// We start it here to display potential error messages from a failed login attempt.
session_start();
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>RMG Admin - Login</title>
    <style>
        body { font-family: Arial, sans-serif; background-color: #f4f4f4; display: flex; justify-content: center; align-items: center; height: 100vh; margin: 0; }
        .login-container { background-color: white; padding: 40px; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.1); width: 100%; max-width: 400px; }
...
<body>
    <div class="login-container">
        ...
        <?php
        // Check if there is a login error message in the session and display it
